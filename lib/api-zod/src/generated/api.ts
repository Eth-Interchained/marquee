...
export const ListStudioEventsResponse = zod.object({
  ...
  "id": zod.string(),
  "workspaceId": zod.string(),
  "kind": zod.enum(['go_live', 'stream_ended', 'scene_saved', 'source_added', 'source_removed', 'stream_error', 'recording_started', 'recording_stopped', 'recording_finalised', 'recording_zoomed', 'recording_captioned', 'recording_error']).describe('What happened on air. A closed list; unknown kinds are rejected.'),
  "at": zod.coerce.date(),
