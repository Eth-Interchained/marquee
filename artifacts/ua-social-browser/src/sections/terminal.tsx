    ...
    >
      <div
        className={cn(
          ...
          runtime.kind === 'checking' && 'ua-ghost',
        )}
                ...
                {runtime.kind === 'unavailable' ? (
                  <>
                    ...
                    <p className="text-xs text-muted-foreground">
                      The terminal is served by the desktop shell’s bundled Python. Run the shell (<code>pnpm --filter @workspace/ua-shell start</code>) rather than the web dev server.
                    </p>
                  </>
