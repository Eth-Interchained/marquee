...
/**
 * Reveal timing. These must match `.mq-revealing` in `index.css`.
 *
...
function GhostSuggestion() {
  return (
    <Card className="mq-ghost" aria-hidden="true">
      <CardContent className="space-y-3 p-4">
        <div className="flex items-center justify-between gap-3">
          <div className="mq-ghost-bar h-3 w-20" />
          <div className="mq-ghost-bar h-3 w-12" />
        </div>
        <div className="space-y-2">
          <div className="mq-ghost-bar h-3.5 w-full" />
          <div className="mq-ghost-bar h-3.5 w-[92%]" />
          <div className="mq-ghost-bar h-3.5 w-[64%]" />
        </div>
        <div className="mq-ghost-bar h-3 w-2/5" />
        <div className="flex gap-2 pt-1">
          <div className="mq-ghost-bar h-8 w-28" />
          <div className="mq-ghost-bar h-8 w-20" />
        </div>
      </CardContent>
    </Card>
  );
...
export function Composer({ state, updateState, workspace }: SectionProps) {
  ...
  /** How long the holo sweep runs. Matches `.mq-dissolving` in index.css. */
                ...
                {chat.length > 0 ? (
                  ...
                  >
                    ...
                    {brief.isPending ? (
                      ...
                      <div className="mq-thinking h-9 w-3/5" data-testid="prompt-thinking" />
                    ) : null}
                  </div>
                ) : null}
                ...
                */}
                ...
                <div className="flex items-end gap-2">
                  ...
                  <Button
                    ...
                    className={cn(brief.isPending && "mq-charging")}
                ...
                <div className="flex items-center gap-2">
                  {suggestions.length > 0 ? (
                    <Button
                      ...
                      className={cn(pendingMode === "more" && "mq-charging")}
                  ...
                  <Button
                    ...
                    disabled={!canSubmit}
                    className={cn(pendingMode === "replace" && "mq-charging")}
            ...
            suggestions.map((suggestion) => {
              ...
              return (
                <Card
                  key={suggestion.id}
                  className={cn(
                    dissolving[suggestion.id] && "mq-dissolving",
